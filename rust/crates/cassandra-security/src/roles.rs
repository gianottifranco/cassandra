...
///
/// Suitable for single-node and testing. Durable roles are handled by
/// `PersistentRoleManager` in this crate and by the server's system_auth
/// storage-backed role manager.
