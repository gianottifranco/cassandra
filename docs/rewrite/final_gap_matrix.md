...
**Baseline**: trunk `076c6f11` | Stable ref: `cassandra-5.0`
...
| `partial` | 30 | Core logic implemented, gaps documented |
| `stub` | 11 | API surface exists, minimal logic |
| `missing` | 14 | Not yet started |
| `trunk-only` | 2 | Present only in trunk, feature-gated |
| `experimental` | 3 | Flagged experimental upstream |
| `baseline-excluded` | 3 | Excluded with justification |

**Total features tracked**: 63
